...
int servoPin1 = 9;  // Change to your desired pin number
int servoPin2 = 10; // Change to your desired pin number
int servoPin3 = 11; // Change to your desired pin number

const int trigPin1 = 3; // Change to your desired pin number
const int echoPin1 = 2; // Change to your desired pin number
const int trigPin2 = 5; // Change to your desired pin number
const int echoPin2 = 4; // Change to your desired pin number
const int trigPin3 = 7; // Change to your desired pin number
...
if(digitalRead(8)==HIGH)
{
  ...
  float cutie1[]={25.2,30.2,25.2};
  bubbleSort(cutie1,3);
  float cutie2[]={30.7,40.2,35.2};
  bubbleSort(cutie2,3);
  float cutie3[]={60.2,40.2,45.2};
  bubbleSort(cutie3,3);
